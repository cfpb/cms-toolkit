			...
			if ( has_term( '', $taxonomy, $post->id ) ) {
				...
				foreach ( $terms as $term ) {
					...
					if ( is_numeric( $term->name ) ) {
						...
						?><span><a id="<?php echo esc_attr( $taxonomy ) ?>-check-num-<?php echo esc_attr( $i ) ?>" class="ntdelbutton<?php echo esc_attr( $term->name ) ?>"><?php echo esc_attr( $term->name ) ?></a>&nbsp;<?php echo $natdate ?></span><?php
					} else {
						?><span><a id="<?php echo esc_attr( $taxonomy ) ?>-check-num-<?php echo esc_attr( $i ) ?>" class="ntdelbutton<?php echo esc_attr( $term->name ) ?>"><?php echo esc_attr( $term->name ) ?></a>&nbsp;<?php echo esc_attr( $term->name ) ?></span><?php
					}
